...
const HOME_UI_COPY = {
  "zh-CN": {
    ...
    join: {
      body: "上传你的摄影、插画或 AI 作品。作品会经过人工整理，再进入公开壁纸库。",
      drag: "拖拽上传你的作品",
      eyebrow: "创作者计划",
  ...
  en: {
    ...
    hero: {
      ...
      searchPlaceholder: "Search nature, dark, city...",
      searchSubmit: "Search",
      shortcutDarkroom: "Darkroom",
      shortcutMotion: "Motion",
      shortcutUpload: "Upload",
    ...
    join: {
      body: "Upload photography, illustration, or AI work. Submissions are curated before they enter the public wallpaper library.",
      drag: "Drag your work here",
      eyebrow: "Creator program",
      limit: "JPG · PNG · WEBP · max 50MB",
      metricCreators: "Artist sets",
      metricRevenue: "Review flow",
  ...
  ja: {
    ...
    hero: {
      ...
      h1Line2: "見られる価値がある。",
      searchLabel: "壁紙を検索",
      searchPlaceholder: "自然、ダーク、都市を検索...",
      searchSubmit: "検索",
      shortcutDarkroom: "暗室",
    ...
    join: {
      body: "写真、イラスト、AI 作品をアップロード。公開ライブラリに入る前に、投稿はキュレーションされます。",
      drag: "作品をドラッグしてアップロード",
      eyebrow: "クリエイタープログラム",
      limit: "JPG · PNG · WEBP · 最大 50MB",
      metricCreators: "アーティスト集",
      metricRevenue: "審査フロー",
      metricWorks: "収録作品",
      titleLine1: "あなたの",
      titleLine2: "レンズの中の",
  ...
  ko: {
    ...
    join: {
      body: "사진, 일러스트, AI 작품을 업로드하세요. 공개 라이브러리에 들어가기 전에 제출물이 큐레이션됩니다.",
      drag: "작품을 끌어 업로드",
      eyebrow: "크리에이터 프로그램",
      limit: "JPG · PNG · WEBP · 최대 50MB",
      metricCreators: "아티스트 세트",
      metricRevenue: "검토 흐름",
      metricWorks: "수록 작품",
      titleLine1: "당신의",
      titleLine2: "렌즈 속",
...
const LOCALIZED_HOME_DATA_COPY = {
  ...
  en: {
    ...
    stats: {
      creators: "Artist sets",
      monthlyUsers: "Motion loops",

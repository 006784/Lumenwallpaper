    ...
    Tables: {
      ...
      wallpapers: {
        Row: {
          ...
          safety_provider: string | null;
          safety_status: string;
          safety_risk_level: string | null;
          safety_adult: string | null;
          safety_racy: string | null;
          safety_violence: string | null;
          safety_medical: string | null;
          safety_spoof: string | null;
